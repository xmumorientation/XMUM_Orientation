...
export const ROLE_NAVIGATION: Record<UserRole, NavigationItem[]> = {
  ...
  admin: [
    ...
    { href: "/admin/users", label: "Accounts", code: "AC", permission: "accounts.manage" },
    { href: "/admin/stations", label: "Configuration", code: "CF", permission: "configuration.manage" },
    { href: "/admin/blindbox", label: "Blind Box", code: "BB", permission: "configuration.manage" },
