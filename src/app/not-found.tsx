  ...
  return (
    <div className="flex min-h-dvh items-center justify-center p-6">
      <div className="card w-full max-w-md p-6 text-center">
        <span className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-star-cyansoft/20 text-sm font-black tracking-tight text-star-cyanstrong">
          VX
        </span>
